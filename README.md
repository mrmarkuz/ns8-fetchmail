...
1. Click on [Use this template](https://github.com/NethServer/ns8-fetchmail/generate).
...
1. Rename some references inside the repo:
   ...
   git mv imageroot/systemd/user/fetchmail.service imageroot/systemd/user/${modulename}.service &&
   git mv imageroot/systemd/user/fetchmail-app.service imageroot/systemd/user/${modulename}-app.service && 
   git mv tests/fetchmail.robot tests/${modulename}.robot &&
   sed -i "s/fetchmail/${modulename}/g" $(find .github/ * -type f) &&
